...
/**
 * Servlet implementation class ClassTable
 */
@WebServlet("/ClassTable")
public class ClassTable extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while(rs.next()) {
				out.print("<tr><td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getInt(3)+"</tr></td>");
			}
			out.print("</table>");
